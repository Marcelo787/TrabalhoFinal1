...
class ListaClienteFragment: Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var _binding: FragmentListaClienteBinding? = null
    private var adapterClientes : AdapterCliente? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListaClienteBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterClientes = AdapterCliente(this)
        binding.recyclerViewCliente.adapter = adapterClientes
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> =
        CursorLoader(
            requireContext(),
            ContentProviderViagem.ENDERECO_CLIENTES,
