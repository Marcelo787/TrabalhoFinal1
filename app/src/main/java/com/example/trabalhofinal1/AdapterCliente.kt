...
class AdapterCliente(val fragment: ListaClienteFragment) : RecyclerView.Adapter<AdapterCliente.ViewHolderCliente>() {
    ...
    inner class ViewHolderCliente(itemCliente: View) : RecyclerView.ViewHolder(itemCliente), View.OnClickListener {
        val textViewNome = itemCliente.findViewById<TextView>(R.id.textViewNome)
        val textViewCc = itemCliente.findViewById<TextView>(R.id.textViewCc)
        val textViewTelemovel = itemCliente.findViewById<TextView>(R.id.textViewTelemovel)
        val textViewEmail = itemCliente.findViewById<TextView>(R.id.textViewEmail)
        ...
        var cliente : Cliente? = null
            ...
            set(value: Cliente?) {
                ...
                textViewCc.text = cliente?.cc ?: ""
                textViewTelemovel.text = cliente?.telemovel ?: ""
                textViewEmail.text = cliente?.email ?: ""
            }
        ...
        private fun seleciona() {
            ...
            fragment.clienteSeleccionado = cliente
        }
